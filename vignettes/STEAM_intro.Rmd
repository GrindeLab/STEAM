...
Without the `gdsfmt`, `SNPRelate`, and `SeqArray` packages already installed, the STEAM download process will take around 5 minutes before it is completed and ready to run.
...
> **DOES THIS CHANGE MEANING OF 95% CONF INT? ASK KELSEY!**
