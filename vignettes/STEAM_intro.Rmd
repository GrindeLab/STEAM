...
More information about creating a `map` data frame can be found in **Step 1** of Section 3: Required Data Format. The data frame `example_map` can be downloaded from the [STEAM GitHub repository](https://github.com/GrindeLab/STEAM/tree/main/data).
