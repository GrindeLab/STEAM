---
title: "STEAM Vignette"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{STEAM Vignette}
...
To run either approach, we need to do some preparation steps:

1. Create a `map` file containing, at minimum, the chromosome number and genetic position (in centimorgans) of each marker being tested.
