...
#'
#' @return A data table with the average correlation in local ancestry, to be used for 
#' estimating the number of generations since admixture using \code{\link[STEAMcpp]{get_g}}.
#'
#' @import data.table
#'
#' @importFrom stats reshape
#'
#' @seealso \code{\link[STEAMcpp]{get_g}} and \code{\link[STEAMcpp]{get_corr_chr}}
#'
#' @export
